    ...
    public static function checkTWStatus(): string
    {
        ...
        if ($noProdukt || $checkNumberOfLocations || $checkSystemHasBuildings || $noVerordnung || $noAnforderung || $noAnforderungInVerordnung || $noControlEquipment) {
            ...
            if ($noProdukt) {
                ...
                if ($noControlEquipment) {
                    $data .= $missingControlEquipment;
                }
            }
            if ($checkNumberOfLocations) {
                $data .= $missingLocation;
            } else {
                if ($checkSystemHasBuildings) {
                    $data .= $missingBuilding;
                }
            }
            if ($noVerordnung) {
                $data .= $missingVerordnung;
            }
            if ($noAnforderungInVerordnung) {
                $data .= $emptyVerordnungListe;
            }
            if ($noAnforderung) {
                $data .= $emptyAnforderungListe;
            }
            $data .= '</div>';
        }
