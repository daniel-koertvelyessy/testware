...
{
    public static function makePDFEquipmentDataSheet($euqipment_id)
    {
    ...
    public static function makePDFEquipmentControlReport(ControlEvent $controlEvent)
    {
    ...
    public static function printEquipmentLabels(Produkt $produkt)
    {
    ...
    public static function makePDFLabel(int $label_id, ?int $equipment_id = null)
    {
        if (! $label_id) {
            return false;
        }
    ...
    public static function makePDFEquipmentLabel(array $data, EquipmentLabel $equipmentLabel)
    {
    ...
    public static function makePDF($view, $title)
    {
        //        dd($view,$title);
    ...
    public static function printReport($id)
    {
