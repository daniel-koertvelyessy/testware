...
@section('modals')
            ...
            <div class="modal-content">
                ...
                >
                    ...
                    <div class="modal-body">
                        <input type="hidden"
                               name="frmOrigin"
                               id="frmOriginCreateBuildingType"
                               value="location"
                        >
                        @csrf
    ...
    <div class="modal"
         id="modalAddRoomType"
         tabindex="-1"
         aria-labelledby="modalAddRoomTypeLabel"
         aria-hidden="true"
    >
        <div class="modal-dialog">
            <div class="modal-content">
        ...
        <div class="row">
            <div class="col">
                ...
                >
                    ...
                    >
                        <form action="{{ route('building.update',$building) }}"
                              method="post"
                        >
                            @method('PUT')
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <x-selectfield id="location_id"
                                                   label="{{ __('ist zugeordnet') }}"
                                    >
                                        @foreach (App\Location::all() as $loc)
                                            <option value="{{ $loc->id }}" {{ ($loc->id === $building->location_id) ? ' selected ' : '' }}>
                                                {{ $loc->l_label }}
                                            </option>
                                        @endforeach
                                    </x-selectfield>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <x-selectModalgroup id="building_type_id"
                                                        label="{{__('neu anlegen')}}"
                                                        modalid="modalAddBuildingType"
                                                        btnL="neu"
                                    >
                                    ...
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input class="form-check-input"
                                                   ...
                                                   value="1"
                                                   id="b_we_has"
                                                   name="b_we_has" {{ ($building->b_we_has === 1) ? ' checked ' : '' }}>
                    ...
                    <div class="tab-pane fade"
                         id="gebRooms"
                         role="tabpanel"
                         aria-labelledby="gebRooms-tab"
                    >
                        <div class="row">
                            <div class="col">
                                <form class="row gy-2 gx-3  my-3"
                                      action="{{ route('room.store') }}#gebRooms"
                                      method="post"
                                      name="frmAddNewRoom"
                                      id="frmAddNewRoom"
                                >
                                    ...
                                    <div class="col-auto">
                                        <button type="submit"
                                                {{-- @if (!env('app.makeobjekte') ) disabled @endif --}} class="btn btn-primary"
                                        >Neuen Raum anlegen
                                        </button>
                                    </div>
                                </form>
