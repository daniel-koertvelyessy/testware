    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col d-flex justify-content-between">
                <h1 class="h3"><span class="d-none d-md-inline">{{  ('Übersicht Stellplatz')}} </span>{{ $stellplatz->sp_label }}</h1>
            ...
            <div class="col">
                ...
                >
                    ...
                    >
                        <a class="nav-link active"
                           id="compartmentBaseData-tab"
                           data-toggle="tab"
                           href="#compartmentBaseData"
                           role="tab"
                           aria-controls="compartmentBaseData"
                           aria-selected="true"
                        >{{  ('Stammdaten')}}</a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active p-2"
                         id="compartmentBaseData"
                         role="tabpanel"
                         aria-labelledby="compartmentBaseData-tab"
                    >
                        <form action="{{ route('stellplatz.update',$stellplatz) }}"
                              method="post"
                        >
                            @method('PUT')
                            @csrf
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        @foreach(\App\Room::all() as $room)
                                            <option value="{{ $room->id }}" {{ $room->id === $stellplatz->room_id ? ' selected ' : '' }}>{{ $room->r_name }}</option>
                                        @endforeach
                                    </x-selectfield>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <x-selectgroup id="stellplatz_typ_id"
                                                   label="{{ __('Typ') }}"
                                                   btnL="Neu"
                                    >
                            ...
                            <x-btnMain>{{__('Stammdaten speichern')}} <span class="fas fa-download ml-2"></span></x-btnMain>
                        </form>
                    </div>
