...
<div class="container ">
    <div class="row" style="height: 80vh;">
        <div class="col-md-6">
            ...
            <button type="button" class="btn btn-lg btn-primary" id="btnActivateScanner">
                Starte Scanner <i class="fas fa-qrcode"></i>
            </button>
            <div id="reader"></div>
        </div>
    </div>
...
@if (session()->has('status'))
    <div class="toast fixed-top align-self-end bg-light" role="alert" aria-live="assertive" aria-atomic="true">
