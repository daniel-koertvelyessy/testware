    ...
    <div class="container-fluid">
        ...
        <div class="row mt-lg-5 mt-sm-1">
            ...
            <code>DELETE</code>. </p>
                ...
                <p>JSON ist im einfachsten Fall eine <code>Schlüssel : Wert</code>  (engl. <strong>key : value</strong>)  Paar, welches mit einem <code>:</code> getrennt und mit <code>{}</code> Klammern umschlossen wird. Mehrere Paare werden mit einem Komma getrennt. </p>
    ...
    "key" : {
        ...
        "subkey2" : 231.2
                ...
                <div class="duik-callout duik-callout-info mb-5">
                    ...
                    <p class="mb-0">Die obige Beschreibung ist extrem einfach gehalten. Eine komplette Beschreibung des JSON Formates finden Sie auf der offiziellen Seite <a href="https://www.json.org/json-de.html" target="_blank">https://www.json.org/json-de.html</a>.</p>
                </div>
                <p>Eine einfache Abfrage der Datenbank beispielsweise zur Auflistung aller Betriebe in der Datenbank mittels:</p>
        ...
        "ort":"Kleve"
                ...
                <div class="tab-content" id="docs-tabContent">
                    <div class="tab-pane bg-light fade p-3 show active" id="docs-tab-jQuery-content" role="tabpanel" aria-labelledby="docs-tab-jQuery">
                        <pre><code class="language-js">
var data = JSON.stringify({"bezeichner":"kleve021M","name":"Mein neuer Betrieb","adresse":{"name_kurz":"klv021","strasse":"Klever Berg","nr":21,"plz":"47533","ort":"Kleve"}});
