    ...
    <div class="row mt-lg-5 mt-sm-1">
        <div class="col">
                ...
                <ul class="nav nav-pills">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a class="dropdown-item" href="#testWare-Module-Start">Module</a></li>
                            ...
                            <li><a class="dropdown-item" href="#testWare-Berichte-Start">Prüfungen</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
            ...
            <div data-spy="scroll" data-target="#navbar-example2" data-offset="0">
                <h4 id="testWare-Module-Start" class="mt-3">testWare Module</h4>
