    ...
    <div class="row mt-lg-5 mt-sm-1">
        <div class="col">
            <p>{{__('Hier finden Sie die Dokumentation zu den verfügbaren Applikationen')}}</p>
                ...
                <p>...</p>
                <p class="dropdown-divider py-5" id="api-doc-overview"></p>
                <h4 class="mt-3">{{ __('Generelles') }}</h4>
                <p></p>
                <p class="dropdown-divider py-5" id="api-doc-rest"></p>
                <h4 class="mt-3">REST {{ __('Schnittstelle') }}</h4>
                <p></p>
                <p class="dropdown-divider py-5" id="api-doc-data"></p>
                <h4 class="mt-3">API {{ __('Datenstruktur') }}</h4>
                <p></p>
            </div>
        </div>
    </div>
