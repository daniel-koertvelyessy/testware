...
<ul class="navbar-nav mr-auto">
    ...
    <li class="nav-item {{ Request::routeIs('firma.*')  ? ' active ' : '' }} dropdown">
        <a class="nav-link dropdown-toggle"
           ...
           aria-expanded="false"
        ><i class="fas fa-industry"></i> Firmen
        </a>
    ...
    <li class="nav-item {{ Request::routeIs('adresse.*')  ? ' active ' : '' }} dropdown">
        <a class="nav-link dropdown-toggle"
           href="#"
           id="navbarDropdownAdresen"
           role="button"
           data-toggle="dropdown"
           aria-expanded="false"
        ><i class="far fa-address-card"></i> Adressen
        </a>
        <ul class="dropdown-menu"
            aria-labelledby="navbarDropdownAdresen"
        >
            <li>
                <a class="dropdown-item"
    ...
    <li class="nav-item {{ Request::routeIs('profile.*')  ? ' active ' : '' }} dropdown">
        <a class="nav-link dropdown-toggle"
           ...
           data-toggle="dropdown"
           aria-expanded="false"
        ><i class="fas fa-user-friends"></i> Mitarbeiter
        </a>
        <ul class="dropdown-menu"
            aria-labelledby="navbarDropdownAddProdukt"
        >
