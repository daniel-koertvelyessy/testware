            ...
            <div class="col">
                <section class="mb-2 mb-md-4">
                    ...
                    <nav class="tiles-grid">
                        ...
                        >
                            <div class="d-flex align-items-center justify-content-center">
                                <i class="fas fa-book fa-2x" style="max-height: 45px; margin-top: 0.8em;"></i>
                ...
                @if(Auth::user())
                    <section class="mb-2 mb-md-4">
                        ...
                        <nav class="tiles-grid" style="grid-template-columns: 32% 32% 32%;">
                            ...
                            >
                                <span class="icon"><i class="fa fa-industry"></i></span> <span
                                        class="branding-bar text-center">{{__('memStandorte')}}</span>
                            </a>
                            ...
                            >
                                <span class="icon"><i class="fas fa-users"></i></span> <span
                                        class="branding-bar text-center">{{__('Organisation')}}</span>
                            </a>
                            ...
                            >
                                <span class="icon"><i class="fas fa-boxes"></i></span> <span
                                        class="branding-bar text-center">{{__('Produkte')}}</span>
                            </a>
                            <a href="{{ route('verordnung.main') }}"
                               class="tile-small btn-outline-primary rounded"
                               data-role="tile"
                            >
                                <span class="icon"><i class="fas fa-scroll"></i></span> <span
                                        class="branding-bar text-center">{{__('Vorschriften')}}</span>
                            </a>
                            @can('isAdmin',Auth::user())
                                <a href="/admin/"
                                   ...
                                   data-role="tile"
                                >
                                    <span class="icon"><i class="fas fa-user-cog"></i></span> <span
                                            class="branding-bar text-center">{{__('Admin')}}</span>
                                </a>
                            @endcan
                            <a href="{{ route('report.index') }}"
                               ...
                               data-role="tile"
                            >
                                <span class="icon"><i class="far fa-clipboard"></i></span> <span
                                        class="branding-bar text-center">{{__('Berichte')}}</span>
                            </a>
